...
test('ssh:net:sshUrlHelperMixin:createSshSessionAuthBuilder:arg', t => {
	...
	t.is(helper.createSshSessionAuthBuilder(123).date(TEST_DATE).build(TEST_TOKEN_SECRET), 
...
test('ssh:net:sshUrlHelperMixin:createSshSessionAuthBuilder:prop', t => {
	...
	helper.nodeId = 123;
	helper.nodeInstructionAuthBuilder.tokenId = TEST_TOKEN_ID;
	t.is(helper.createSshSessionAuthBuilder().date(TEST_DATE).build(TEST_TOKEN_SECRET), 
		'SNWS2 Credential=test-token-id,SignedHeaders=host;x-sn-date,Signature=6b69e6cdeafc8d810676f0fb18c33c32f7c804a44bd884cee911204992107727');
});
...
test('ssh:net:sshUrlHelperMixin:startSshSessionAuthBuilder:prop', t => {
	const helper = new SshUrlHelper();
	const session = new SshSession(new Date(), 'abc', 123, 'localhost', 8022, 17776);
	helper.nodeId = 123;
	helper.nodeInstructionAuthBuilder.tokenId = TEST_TOKEN_ID;
	helper.sshSession = session;
	t.is(helper.startSshSessionAuthBuilder().date(TEST_DATE).build(TEST_TOKEN_SECRET), 
...
test('ssh:net:sshUrlHelperMixin:connectTerminalWebSocketAuthBuilder:prop', t => {
	...
	helper.nodeInstructionAuthBuilder.tokenId = TEST_TOKEN_ID;
	helper.nodeId = 123;
	t.is(helper.connectTerminalWebSocketAuthBuilder().date(TEST_DATE).build(TEST_TOKEN_SECRET),
...
test('ssh:net:sshUrlHelperMixin:stopSshSessionAuthBuilder:prop', t => {
	...
	helper.nodeInstructionAuthBuilder.tokenId = TEST_TOKEN_ID;
	helper.sshSession = session;
	t.is(helper.stopSshSessionAuthBuilder().date(TEST_DATE).build(TEST_TOKEN_SECRET), 
...
test('ssh:net:sshUrlHelperMixin:viewStartRemoteSshInstructionUrl:prop', t => {
	const helper = new SshUrlHelper();
	const session = new SshSession(new Date(), 'abc', 123, 'localhost', 8022, 17776, 321);
	helper.sshSession = session;
	t.is(helper.viewStartRemoteSshInstructionUrl(),
...
test('ssh:net:sshUrlHelperMixin:viewStartRemoteSshInstructionAuthBuilder:prop', t => {
	...
	helper.nodeInstructionAuthBuilder.tokenId = TEST_TOKEN_ID;
	helper.sshSession = session;
	t.is(helper.viewStartRemoteSshInstructionAuthBuilder().date(TEST_DATE).build(TEST_TOKEN_SECRET),
...
test('ssh:net:sshUrlHelperMixin:viewStopRemoteSshInstructionUrl:prop', t => {
	const helper = new SshUrlHelper();
	const session = new SshSession(new Date(), 'abc', 123, 'localhost', 8022, 17776, 321, 456);
	helper.sshSession = session;
	t.is(helper.viewStopRemoteSshInstructionUrl(),
...
test('ssh:net:sshUrlHelperMixin:viewStartRemoteSshInstructionAuthBuilder:prop', t => {
	...
	helper.nodeInstructionAuthBuilder.tokenId = TEST_TOKEN_ID;
	helper.sshSession = session;
	t.is(helper.viewStopRemoteSshInstructionAuthBuilder().date(TEST_DATE).build(TEST_TOKEN_SECRET),
