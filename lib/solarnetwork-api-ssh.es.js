// https://github.com/SolarNetwork/sn-api-ssh-js Version 0.2.3. Copyright 2019 SolarNetwork Foundation.
import { objectToStringMap, stringMapToObject, ComparableEnum, NodeInstructionUrlHelperMixin, NodeMetadataUrlHelperMixin, UserUrlHelperMixin, NodeUrlHelperMixin, UrlHelper, Environment, AuthorizationV2Builder } from 'solarnetwork-api-core';
  ...
  return (
    ...
    function (_superclass) {
      ...
      function _class() {
        ...
        _this._instructionAuthBuilder = new AuthorizationV2Builder(null, _this._instructionUrlHelper);
        return _this;
      }
      /**
...
export { AttachSshCommand, SolarSshApiPathV1, SolarSshDefaultPath, SolarSshPathKey, SolarSshTerminalWebSocketPath, SolarSshTerminalWebSocketSubProtocol, SshCloseCode, SshCloseCodes, SshCommand, SshSession, SshSessionKey, SshTerminalSettings, SshUrlHelper, SshUrlHelperMixin, StartRemoteSshInstructionName, StopRemoteSshInstructionName };
